...
invoc_data = filter(df_for_invocations, oracle == TRUE)
repl_data = filter(df_for_replicas, oracle == TRUE)
...
```{r}
invoc_data = filter(df_for_invocations, oracle == FALSE & technique != "RequestHedgingDefault")
repl_data = filter(df_for_replicas, oracle == FALSE  & technique != "RequestHedgingDefault")
