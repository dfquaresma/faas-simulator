...
inv2021 = read.csv(paste(azure_path, "/sample-1M.csv", sep=""), header = TRUE)
...
# Merge data  
inv2021_merged = do.call(rbind, inv2021_split_final)
...
# save processed data
write.csv(inv2021_merged, file = paste(azure_path, "/sample-1M-processed.csv", sep=""), row.names = FALSE)
```
