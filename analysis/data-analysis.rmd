...
boxplot_plot <- function(title, df_a, df_b, df_c, yrange, outliershape = NA) {
  return(ggplot(rbind(df_a, df_b, df_c), aes(x=scenario, y=responseTime, fill=scenario)) +
...
## LOAD GENERAL DATA
```{r}
results_path <- "/Users/davidquaresma/Desktop/repos/faas-simulator/results_generated"
...
gci <- select(transform(gci, minResponseTime = pmin(responseTime, rHresponseTime)), responseTime, rHresponseTime, minResponseTime)
...
rh <- select(transform(rh, minResponseTime = pmin(responseTime, rHresponseTime)), responseTime, rHresponseTime, minResponseTime)
...
rhd <- select(transform(rhd, minResponseTime = pmin(responseTime, rHresponseTime)), responseTime, rHresponseTime, minResponseTime)
...
vanilla <- select(transform(vanilla, minResponseTime = pmin(responseTime, rHresponseTime)), responseTime, rHresponseTime, minResponseTime)
...
boxplot_plot("Boxplot for response time", df_gci_to_boxplot, df_rhd_to_boxplot, df_van_to_boxplot, c(0, 5))
```
