...
load_data <- function(result_path, techs, probs, idletimes) {
  technique <- c()
  tailLatencyProb <- c()
  idletime <- c()
  p50 <- c()
...
## LOAD GENERAL DATA
```{r}
result_path <- "/Users/davidquaresma/Desktop/repos/faas-simulator/results_generated"
...
data_loaded <- load_data(result_path, techs, probs, idletimes)
...
rh = read.csv(paste(repo_path, results_path, technique, "/", technique, scenario, sep=""))
...
rhd = read.csv(paste(repo_path, results_path, technique, "/", technique, scenario, sep=""))
...
technique = "Vanilla"
vanilla = read.csv(paste(repo_path, results_path, technique, "/", technique, scenario, sep=""))
