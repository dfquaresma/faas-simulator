...
result_path <- "D:/MESTRADO/repo/faas-simulator/results_sample"
techs <- c('RequestHedgingOpt', 'RequestHedgingDefault', 'Vanilla', 'GCI')
probs      <- c('tlprobp95', 'tlprobp99')
idletimes  <- c('idletimeINF') #c('idletimeINF', 'idletime0.0', 'idletime15.0')
hasOracle <- c('hasOracletrue') #c('hasOraclefalse', 'hasOracletrue')
